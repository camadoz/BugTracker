...
namespace BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,RecipientId,SenderId,Created,Subject,NofificationBody,isRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,RecipientId,SenderId,Created,Subject,NofificationBody,isRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
