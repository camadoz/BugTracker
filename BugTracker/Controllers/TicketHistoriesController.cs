...
namespace BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,PropertyName,OldValue,NewValue,Updated,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,PropertyName,OldValue,NewValue,Updated,UserId")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
